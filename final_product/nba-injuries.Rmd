...
So, it seems like an analysis of the relationship between injury and weight in the NBA is warranted. To do this, we can make use of https://www.kaggle.com/datasets/justinas/nba-players-data?select=all_seasons.csv data from Basketball Reference and https://www.prosportstransactions.com/basketball/.

# Scrape and Load Data

## Injury Data

First, we're going to scrape all the data from https://www.prosportstransactions.com/basketball/.
...
# delete leftover blank
injuries <- injuries[-1,]

```

Finally, we have our dataframe looking exactly how we want it to.
...
Finally, we have our second dataset read, cleaned, and summarized.
...
Now we have our merged dataset, and we can begin to analyze it.
